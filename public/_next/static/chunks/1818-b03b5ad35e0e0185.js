    ...
    21818: function (t, e, n) {
      ...
      function i(t, e) {
        ...
        if (null != t && "function" == typeof Object.getOwnPropertySymbols) {
          var r = 0
          for (c = Object.getOwnPropertySymbols(t); r < c.length; r++)
            e.indexOf(c[r]) < 0 &&
              Object.prototype.propertyIsEnumerable.call(t, c[r]) &&
              (n[c[r]] = t[c[r]])
        }
        return n
      }
                    ...
                    c &&
                      (r =
                        2 & o[0]
                          ? c.return
                          : o[0]
                          ? c.throw || ((r = c.return) && r.call(c), 0)
                          : c.next) &&
                      !(r = r.call(c, o[1])).done)
                  )
                    return r
                  switch (((c = 0), r && (o = [2 & o[0], r.value]), o[0])) {
                    case 0:
                    case 1:
                      r = o
                      break
      ...
      function u(t) {
        var e = function (e) {
          ...
          return c.createElement(
            "svg",
            o({ viewBox: "0 0 64 64", width: u, height: u }, h),
            l
            ...
            c.createElement("path", { d: t.path, fill: a })
          )
        }
        return (
          (e.defaultProps = {
      ...
      function g(t, e, n) {
        ...
        if (n)
          var h = window.setInterval(function () {
            try {
              ;(null === u || u.closed) && (window.clearInterval(h), n(u))
            } catch (t) {
              console.error(t)
            }
          }, 1e3)
                  ...
                  switch (l.label) {
                    case 0:
                      return (
                        ...
                        (o = e.onClick),
                        (i = e.url),
                        (a = e.openShareDialogOnClick),
                        (u = e.opts),
                        (h = r(i, u)),
                        c
                          ? [2]
                          : (t.preventDefault(),
                            n ? ((s = n()), L(s) ? [4, s] : [3, 2]) : [3, 2])
                      )
                    case 1:
                      l.sent(), (l.label = 2)
                    case 2:
                      return a && this.openShareDialog(h), o && o(t, h), [2]
                  }
                })
              })
            }),
        ...
        return (
          ...
          (e.prototype.render = function () {
            var t = this.props,
              ...
              r = t.networkName,
              a = t.style,
              l = i(t, ["children", "forwardedRef", "networkName", "style"]),
              u = o(
                {
      ...
      function H(t, e, n, r) {
        ...
        return (i.displayName = "ShareButton-".concat(t)), (0, c.forwardRef)(i)
      }
      var j = H(
          "facebook",
          function (t, e) {
            return (
              ...
              M({ u: t, quote: e.quote, hashtag: e.hashtag })
            )
          },
          function (t) {
        ...
        W =
          (H(
            ...
            function (t, e) {
              return (
                ...
                M({ url: t, media: e.media, description: e.description })
              )
            },
            function (t) {
              return { media: t.media, description: t.description }
            },
          ...
          H(
            ...
            function (t, e) {
              return (
                "https://www.reddit.com/submit" + M({ url: t, title: e.title })
              )
            },
            function (t) {
              return { title: t.title }
        ...
        V = H(
          "telegram",
          function (t, e) {
            return "https://telegram.me/share/" + M({ url: t, text: e.title })
          },
          function (t) {
            return { title: t.title }
          },
        ...
        S =
          (H(
            ...
            function (t, e) {
              var n = e.title,
                c = e.separator
              return "viber://forward" + M({ text: n ? n + c + t : t })
            },
            function (t) {
              return { title: t.title, separator: t.separator || " " }
            },
            { windowWidth: 660, windowHeight: 460 }
          ),
          H(
            ...
            function (t, e) {
              return (
                ...
                M({ url: t, title: e.title, pic: e.image })
              )
            },
            function (t) {
              return { title: t.title, image: t.image }
            },
            {
              windowWidth: 660,
              windowHeight: 550,
        ...
        x =
          ...
          H(
            ...
            function (t, e) {
              return (
                ...
                M({ subject: e.title, event: e.description })
              )
            },
            function (t) {
          ...
          H(
            ...
            function (t, e) {
              return (
                "https://getpocket.com/save" + M({ url: t, title: e.title })
              )
            },
            function (t) {
              return { title: t.title }
          ...
          H(
            ...
            function (t, e) {
              return (
                ...
                M({ url: t, title: e.title, description: e.description })
              )
            },
            function (t) {
              return { title: t.title, description: t.description }
          ...
          H(
            ...
            function (t, e) {
              var n = e.title
              return "http://b.hatena.ne.jp/add?mode=confirm&url="
                .concat(t, "&title=")
                .concat(n)
            },
            function (t) {
          ...
          H(
            ...
            function (t) {
              return { appId: t.appId, redirectUri: t.redirectUri, to: t.to }
            },
        ...
        E = H(
          ...
          function (t, e) {
            var n = e.subject,
              c = e.body,
              r = e.separator
            return "mailto:" + M({ subject: n, body: c ? c + r + t : t })
          },
          function (t) {
            return {
              subject: t.subject,
